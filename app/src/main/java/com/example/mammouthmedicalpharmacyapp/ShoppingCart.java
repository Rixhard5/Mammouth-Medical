        ...
        cartRef.whereEqualTo("itemId", currentItem.getItemId())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Log.w(LOG_TAG, "Error deleting document: " + task.getResult());
                        Toast.makeText(this, "Error removing item: " + task.getResult(), Toast.LENGTH_LONG).show();
                    }
                });
    }
            ...
            cartRef.whereEqualTo("itemId", currentItem.getItemId())
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Log.w(LOG_TAG, "Error updating document: " + task.getResult());
                            Toast.makeText(this, "Error removing 1 item: " + task.getResult(), Toast.LENGTH_LONG).show();
                        }
                    });
        } else {
